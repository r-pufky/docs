...
#   :data:   true
#
# .. ctree:: Enable Dynamic DNS Option 2
...
class ConfigTreeData(config_table.ConfigTableData):
...
class ConfigTree(config_table.ConfigTable):
  """Generate config tree elements in a sphinx document.
  ...
  def _sanitize_options(self):
    ...
    * Parses directive arguments for title.
    ...
    Returns:
      ConfigTreeData object containing sanitized directive data.
    """
...
def setup(app):
  ...
  app.add_directive('ctree', ConfigTree)