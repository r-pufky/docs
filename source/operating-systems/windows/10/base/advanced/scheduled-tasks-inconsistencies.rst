.. _w10-scheduled-tasks-inconsistencies:
...
.. _extracted from the manually: https://docs.microsoft.com/en-us/archive/blogs/wincat/trigger-a-powershell-script-from-a-windows-event
