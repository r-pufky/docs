...
.. dropdown:: Disable error reporting
  ...
  .. dropdown:: :term:`Registry`
    ...
    .. wregedit:: Disable error reporting
      :key_title: HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\
                  Windows Error Reporting
      :names:     Disabled
      :types:     DWORD
      :data:      1
    ...
    `Reference <https://github.com/adolfintel/Windows10-Privacy#turn-off-windows-error-reporting>`__
  ...
  .. dropdown:: :term:`GPO`
    ...
    `Reference <https://auditsquare.com/advisory/windows/error-reporting>`__
