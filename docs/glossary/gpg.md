...
## Encryption Key
Key used to encrypt data. Data is typically signed with the [Signing
Key](#signing-key) after encryption.

## Authentication Key
Key used to Authenticate to systems (e.g. SSH). This will allow other systems
