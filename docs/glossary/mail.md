...
## DKIM
Domain Key Identified Mail: [DKIM provides](http://dkim.org/) a method for
validating a domain name identity that is associated with an email message
...
## SPF
[Sender Policy
Framework](https://en.wikipedia.org/wiki/Sender_Policy_Framework): Email
authentication method designed to detect forging sender addresses during the
