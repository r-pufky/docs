...
Download [Seemless Coop](https://github.com/LukeYui/EldenRingSeamlessCoopRelease/releases)
and extract to Elden Ring location (Steam ➔ Elden Ring ➔ RMB ➔ Manage ➔
Browse Local Files).

Modify settings to taste:

**Game/SeamlessCoop/ersc_settings.ini** (1)
{ .annotate }
...
!!! example "Copy to Proton Profile"
    cp -av /mnt/win/Users/{USER}/AppData/Roaming/EldenRing/ \
      ~/.local/share/Steam/steamapps/compatdata/1245620/pfx/drive_c/users/steamuser/AppData/Roaming/EldenRing/{STEAMID64}
