...
See [vim adventure](https://vim-adventures.com) for a game to learn vim, and
[stackoverflow most useful vim
shortcuts](https://stackoverflow.com/questions/1218390/what-is-your-most-productive-shortcut-with-vim/1220118#1220118).

Highly customized default **~/.vimrc** (1)
{ .annotate }
