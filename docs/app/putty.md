...
Use [VcXsrv](https://sourceforge.net/projects/vcxsrv/files/vcxsrv/) instead of
xming. This is fully functional and does not have copy/paste or resizing
disabled. Install as normal.

**c:\Program Files\VcXsrv\config.xlaunch** (1)
{ .annotate }
