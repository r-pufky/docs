...
!!! example "Migrated to ansible collection"
    Use [r_pufky.srv.firefly](https://galaxy.ansible.com/ui/repo/published/r_pufky/srv/docs/).
...
Set **firefly_trusted_proxies** to ** or specific proxy IP before enabling the reverse-proxy. **firefly_app_url** should remain localhost as it does not
