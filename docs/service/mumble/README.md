...
**/etc/mumble-server.ini** (1)
{ .annotate }

1. 0600 mumble-server:mumble-server
``` bash
...
* https://www.typefrag.com/mumble/tutorials/advanced-user-settings/
* https://www.mumble.com/support/mumble-how-to-create-a-channel.php
