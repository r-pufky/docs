...
## Create Certificates
Use a [Yubikey GPG Key (Linux)](../../app/gpg/os/linux.md#configure-sshgpg-agent)
or [Yubikey GPG Key (Windows)](../../app/gpg/os/windows.md#configure-gpg-agent).
...
5. Delete RSA keys (use
   [sdelete64](https://docs.microsoft.com/en-us/sysinternals/downloads/sdelete)
   ).
...
* http://postsbylukman.blogspot.com/2017/09/difference-between-internal-sftp-and.html