...
!!! example "Migrated to ansible collection"
    Use [r_pufky.srv.nginx](https://galaxy.ansible.com/ui/repo/published/r_pufky/srv/docs/).
...
A detailed [Nginx Administration Handbook is
here](https://github.com/trimstray/nginx-admins-handbook/blob/master/README.md).
