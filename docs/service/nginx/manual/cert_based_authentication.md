...
See [Certificate Authority][b] for instructions on setting up required
certificates used here. An excellent reference for [basic certificate usage][c]
...
??? abstract "/etc/nginx/conf.d/server_cert_authentication.conf"
    0644 root:root
...
* This provices **Authentication (authn)** [See Certificate Authorization][e]
  for **authorization** setup.
* **If** statements should only be used to for **rewrite** and **return**
  (**proxy_pass** is a **rewrite** statement). See [if-is-evil][f].
* Access can be provided based on client certificate presented as well (e.g.
  specific [access for specific certificates][g].
...
## [Auto-select Client Certificate][m]
Auto selecting the [correct certificate][l] will enable transparent
...
=== "Linux"
    !!! abstract "/etc/opt/chrome/policies/managed/auto_select_certificate.json"
        0644 root:root
     ...
     All directories on path **must** be readable by others.

Restarting chrome will pickup the configuration changes.


## [Firefox Client Certificate][n]
...
[a]: https://fardog.io/blog/2017/12/30/client-side-certificate-authentication-with-nginx
[b]: ../../ca/setup.md
[c]: https://jamielinux.com/docs/openssl-certificate-authority/introduction.html
[e]: #certificate-authorization-authz
[f]: https://www.nginx.com/resources/wiki/start/topics/depth/ifisevil
[g]: https://stackoverflow.com/questions/41513400/nginx-authorization-based-on-client-certificates
[h]: ../troubleshooting.md#debug-nginx-configs
[i]: https://stackoverflow.com/questions/9008309/how-do-i-set-git-ssl-no-verify-for-specific-repos-only
[j]: http://www.wakoond.hu/2013/07/using-git-with-https-client-certificate.html
[k]: https://www.tbs-certificates.co.uk/FAQ/en/installer_certificat_client_google_chrome.html
[l]: https://blogs.sap.com/2014/01/30/avoid-certification-selection-popup-in-chrome
[m]: https://chromeenterprise.google/policies/#AutoSelectCertificateForUrls
[n]: https://stackoverflow.com/questions/27864553/how-can-i-choose-a-different-client-certificate-in-firefox
