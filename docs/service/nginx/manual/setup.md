...
[Automatic generator][a] to generate base configuration templates.
...
* The [**SERVER DNS NAME** should be in the SSL certificate][c]; a wildcard
...
[a]: https://www.digitalocean.com/community/tools/nginx
[b]: https://medium.com/@utkarsh_verma/how-to-obtain-a-wildcard-ssl-certificate-from-lets-encrypt-and-setup-nginx-to-use-wildcard-cfb050c8b33f
[c]: https://community.letsencrypt.org/t/no-resolver-defined-to-resolve-ocsp-int-x3-letsencrypt-org-while-requesting-certificate-status-responder-ocsp-int-x3-letsencrypt-org/21427
