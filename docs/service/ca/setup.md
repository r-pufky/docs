...
### [Create Root CA OpenSSL Configuration][a]
A [good default][a] is here. This configuration should only contain relevant
...
### [Create Root CA Private Key and Certificate][b]
...
### [Create Intermediate CA Openssl Configuration][c]
A [good default][c] is here. This configuration should only contain relevant
...
??? abstract "/root/ca/inter/inter.ca"
    0600 root:root
...
### [Create Intermediate CA Private Key and Certificate][d]
...
[a]: https://jamielinux.com/docs/openssl-certificate-authority/appendix/root-configuration-file.html
[b]: https://jamielinux.com/docs/openssl-certificate-authority/create-the-root-pair.html
[c]: https://jamielinux.com/docs/openssl-certificate-authority/appendix/intermediate-configuration-file.html
[d]: https://jamielinux.com/docs/openssl-certificate-authority/create-the-intermediate-pair.html
